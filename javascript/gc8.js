...
//GC8
//diamond-fr
var query1 = 'SELECT SUM(tickets_sold) FROM dataset0 WHERE ticket_type_id IN (369)';
...
var query2 = 'SELECT SUM(tickets_left) FROM dataset0 WHERE ticket_type_id IN (369)';
...
var query3 = 'SELECT SUM(tickets_confirmed) FROM dataset0 WHERE ticket_type_id IN (369)';
...
var query3a = 'SELECT COUNT(*) FROM dataset1 WHERE ticket_type_id IN (369)';
...
//diamond
var query4 = 'SELECT SUM(tickets_sold) FROM dataset0 WHERE ticket_type_id IN (368)';
...
var query5 = 'SELECT SUM(tickets_left) FROM dataset0 WHERE ticket_type_id IN (368)';
...
var query6 = 'SELECT SUM(tickets_confirmed) FROM dataset0 WHERE ticket_type_id IN (368)';
...
var query6a = 'SELECT COUNT(*) FROM dataset1 WHERE ticket_type_id IN (368)';
domo.post('/sql/v1/dataset1', query6a, {contentType: 'text/plain'}).then(result6a);
 function result6a(data){
  console && console.log(data);
  document.getElementById("gc8-diamond-seat").innerHTML = data['rows'][0][0];
}
//premier
var query7 = 'SELECT SUM(tickets_sold) FROM dataset0 WHERE ticket_type_id IN (367)';
...
var query8 = 'SELECT SUM(tickets_left) FROM dataset0 WHERE ticket_type_id IN (367)';
...
var query9 = 'SELECT SUM(tickets_confirmed) FROM dataset0 WHERE ticket_type_id IN (367)';
...
var query9a = 'SELECT COUNT(*) FROM dataset1 WHERE ticket_type_id IN (367)';
domo.post('/sql/v1/dataset1', query9a, {contentType: 'text/plain'}).then(result9a);
 function result9a(data){
  console && console.log(data);
  document.getElementById("gc8-premier-seat").innerHTML = data['rows'][0][0];
}
//vip
var query10 = 'SELECT SUM(tickets_sold) FROM dataset0 WHERE ticket_type_id IN (366)';
...
var query11 = 'SELECT SUM(tickets_left) FROM dataset0 WHERE ticket_type_id IN (366)';
...
var query12a = 'SELECT COUNT(*) FROM dataset1 WHERE ticket_type_id IN (366)';
domo.post('/sql/v1/dataset1', query12a, {contentType: 'text/plain'}).then(result12a);
...
domo.post('/sql/v1/dataset0', query13, {contentType: 'text/plain'}).then(result13);
 function result13(data){
  console && console.log(data);
  document.getElementById("gc8-exec-tickets_sold").innerHTML = 1875 //data['rows'][0][0];
}
var query14 = 'SELECT SUM(tickets_left) FROM dataset0 WHERE ticket_type_id IN (365)';
domo.post('/sql/v1/dataset0', query14, {contentType: 'text/plain'}).then(result14);
 function result14(data){
  console && console.log(data);
  document.getElementById("gc8-exec-tickets_left").innerHTML = 0 //data['rows'][0][0];
}
var query15 = 'SELECT SUM(tickets_confirmed) FROM dataset0 WHERE ticket_type_id IN (365)';
...
//gc8-virtual
var query16 = 'SELECT SUM(tickets_sold) FROM dataset0 WHERE ticket_type_id IN (384)';
...
//gc8 total sold
var query17 = 'SELECT SUM(tickets_sold) FROM dataset0 WHERE ticket_type_id IN (365,366,367,368,369)';
...
//gc8 total left
var query18 = 'SELECT SUM(tickets_left) FROM dataset0 WHERE ticket_type_id IN (365,366,367,368,369)';
...
//gc8 total confirmed
var query19 = 'SELECT SUM(tickets_confirmed) FROM dataset0 WHERE ticket_type_id IN (365,366,367,368,369)';
...
domo.post('/sql/v1/dataset0', query21, {contentType: 'text/plain'}).then(result21);
 function result21(data){
  console && console.log(data);
  document.getElementById("dia-capacity").innerHTML = data['rows'][0][0];
}
...
domo.post('/sql/v1/dataset0', query22, {contentType: 'text/plain'}).then(result22);
 function result22(data){
  console && console.log(data);
  document.getElementById("pre-capacity").innerHTML = data['rows'][0][0];
}
...
domo.post('/sql/v1/dataset0', query23, {contentType: 'text/plain'}).then(result23);
 function result23(data){
  console && console.log(data);
  document.getElementById("vip-capacity").innerHTML = data['rows'][0][0];
}
...
domo.post('/sql/v1/dataset0', query24, {contentType: 'text/plain'}).then(result24);
 function result24(data){
  console && console.log(data);
  document.getElementById("exec-capacity").innerHTML = data['rows'][0][0];
}
//timer 1
