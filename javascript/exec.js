...
//vip
var query2 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 665 AND ticket_type_id = 654';
...
//executive
var query3 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 665 AND ticket_type_id in (653)';
...
//total
var query4 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 665 AND ticket_type_id in (653,654,655)';
...
//GROWTH CONFERENCE
//diamon-fr
var query5 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 548 AND ticket_type_id in (369)';
...
var query6 = 'SELECT COUNT(*) FROM dataset1 WHERE event_id = 548 AND ticket_type_id in (369)';
...
//in-person
var query18 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 489 AND ticket_type_id in (230)';
...
var query19 = 'SELECT COUNT(*) FROM dataset1 WHERE event_id = 489 AND ticket_type_id in (230)';
...
//virtual
var query20 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 489 AND ticket_type_id in (231)';
...
//ult-vip
var query21 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 501 AND ticket_type_id = 259';
...
var query22 = 'SELECT COUNT(*) FROM dataset1 WHERE event_id = 501 AND ticket_type_id = 259';
...
//super-vip
var query23 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 501 AND ticket_type_id = 631';
...
//executive
var query27 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 501 AND ticket_type_id = 257';
...
var query28 = 'SELECT COUNT(*) FROM dataset1 WHERE event_id = 501 AND ticket_type_id = 257';
...
//total
var query29 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 501 AND ticket_type_id in (257,258,259,631)';
...
var query30 = 'SELECT COUNT(*) FROM dataset1 WHERE event_id = 501 AND ticket_type_id in (257,258,259,631)';
...
//virtual
var query31 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 501 AND ticket_type_id in (260)';
...
//10X BUSINESS SUMMIT
//super-vip
var query32 = 'SELECT COUNT(*) FROM dataset2 WHERE ticket_type in (102,508)';
domo.post('/sql/v1/dataset2', query32, {contentType: 'text/plain'}).then(result32);
 function result32(data){
  console && console.log(data);
  document.getElementById("bs-super-vip-tickets_sold").innerHTML = data['rows'][0][0];
}
var query33 = 'SELECT COUNT(*) FROM dataset2 WHERE ticket_type in (102,508) and confirmed=1';
domo.post('/sql/v1/dataset2', query33, {contentType: 'text/plain'}).then(result33);
 function result33(data){
  console && console.log(data);
  document.getElementById("bs-super-vip-tickets_confirmed").innerHTML = data['rows'][0][0];
}
//vip
var query34 = 'SELECT COUNT(*) FROM dataset2 WHERE ticket_type in (101,319)';
domo.post('/sql/v1/dataset2', query34, {contentType: 'text/plain'}).then(result34);
...
//executive
var query36 = 'SELECT COUNT(*) FROM dataset2 WHERE ticket_type in (100,318)';
domo.post('/sql/v1/dataset2', query36, {contentType: 'text/plain'}).then(result36);
...
//total
var query38 = 'SELECT COUNT(*) FROM dataset2';
...
//SALES ESSENTIAL
//in-person
var query40 = 'SELECT COUNT(*) FROM dataset0 WHERE event_id = 495 AND ticket_type_id in (242)';
